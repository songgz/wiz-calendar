...
describe('Moonphase Class', () => {
    test('getMoonphase method', () => {
        ...
        let phase = l1.getMoonPhase(MoonPhaseName.NewMoon);
        console.log(phase.getJulianDate().getMJDN());
        expect(phase.getJulianDate().getMJD()).toBeCloseTo(-8263.047660221844, 10);
