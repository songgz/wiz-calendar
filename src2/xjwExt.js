...
var touY = {MollY: new Array(), MollCZ: function (W) {
...
var SZJ = {L: 0, fa: 0, dt: 0, E: 0.409092614, getH: function (h, w) {
...
var ysPL = {lineT: function (G, v, u, r, n) {
...
var rsGS = {Zs: new Array(), Zdt: 0.04, Zjd: 0, dT: 0, tanf1: 0.0046, tanf2: 0.0045, srad: 0.0046, bba: 1, bhc: 0, dyj: 23500, init: function (jd, n) {
...
var rsPL = {nasa_r: 0, sT: new Array(), secXY: function (jd, L, fa, high, re) {
    var deltat = dt_T(jd);
    var zd = nutation2(jd / 36525);
...
}, A: new Array(), B: new Array(), P: {S: new Array(), M: new Array(), g: 0}, Q: {S: new Array(), M: new Array(), g: 0}, V: new Array(), Vc: '', Vb: '', zb0: function (jd) {
    var deltat = dt_T(jd);
    var E = hcjj(jd / 36525);
    var zd = nutation2(jd / 36525);
...
var oba = {wFtv: new Array('0150I世界麻风日', '0520.国际母亲节', '0530I全国助残日', '0630.父亲节', '0730.被奴役国家周', '0932I国际和平日', '0940.国际聋人节 世界儿童日', '0950I世界海事日', '1011.国际住房日', '1013I国际减轻自然灾害日(减灾日)', '1144I感恩节'), sFtv: '', init: function () {
    var i;
...
function Lunar() {
    ...
    this.lun.dn = 0;
    this.lunqi = new Array();
    for (i = 0; i < 30; i++)this.lunqi[i] = new Object();
    this.lunqi.dn = 0;
    ...
    this.yueLiCalc = function (By, Bm) {
        ...
        var d, w0, hou, xn, jd2 = Bd0 + dt_T(Bd0) - 8 / 24;
        ...
        do {
            d = obb.qi_accurate(w);
            D = int2(d + 0.5);
            hou = (int2((w - w0) / pi2 * 72 + 0.5) % 3 + 3) % 3;
            if (!hou)xn = int2(w / pi2 * 24 + 24000006.01) % 24;
            w += pi2 / 72;
            if (D >= Bd0 + Bdn)break;
            if (D < Bd0)continue;
            ob = this.lun[D - Bd0];
            ob.jqmc = hou == 1 ? '二候' : hou == 2 ? '三候' : obb.jqmc[xn];
            ob.jqjd = d;
    ...
    this.yueLiHTML = function (By, Bm, curJD) {
        ...
        for (i = 0; i < this.dn; i++) {
            ...
            c = '', isM = '';
            if (ob.A)c += '<font color=red>' + this.substr2(ob.A, 3, '.') + '</font>';
            if (!c && ob.B)c = '<font color=blue>' + this.substr2(ob.B, 3, '.') + '</font>';
            ...
            if (ob.jqmc) {
                if (ob.jqmc == "二候")isM += '<font color=#00C030>▲</font>'; else if (ob.jqmc == "三候")isM += '<font color=#00C0A0>▲</font>'; else if (ob.jqmc == "立春" || ob.jqmc == "惊蛰" || ob.jqmc == "清明" || ob.jqmc == "立夏" || ob.jqmc == "芒种" || ob.jqmc == "小暑" || ob.jqmc == "立秋" || ob.jqmc == "白露" || ob.jqmc == "寒露" || ob.jqmc == "立冬" || ob.jqmc == "大雪" || ob.jqmc == "小寒")isM += '<font color=#00C000>◆</font>'; else isM += '<font color=#00C0C0>■</font>';
            }
            ;
        ...
        var b2 = '', b3 = '', b4 = '', b5 = '', j1 = j2 = j3 = j4 = 0;
        for (i = 0; i < this.dn; i++) {
            ob = this.lun[i];
            c = i + 1;
            if (c < 10)c = '&nbsp;' + c;
            if (ob.yxmc == '朔' || ob.yxmc == "望")b2 += (j1 ? j1 % 2 ? ' &nbsp' : '<br>' : '') + c + '日 ' + ob.yxsj + ob.yxmc + '月', j1++;
            if (ob.yxmc == '上弦' || ob.yxmc == "下弦")b3 += (j2 ? j2 % 2 ? ' &nbsp' : '<br>' : '') + c + '日 ' + ob.yxsj + ob.yxmc, j2++;
            if (ob.jqmc)if (ob.jqmc != "二候" && ob.jqmc != "三候")b4 += (j3 ? j3 % 2 ? ' &nbsp' : '<br>' : '') + c + '日 ' + ob.jqsj + ob.jqmc, j3++; else b5 += (j4 ? j4 % 2 ? ' &nbsp' : '<br>' : '') + c + '日 ' + ob.jqsj + ob.jqmc, j4++;
        }
        this.pg2 = b2 + '<br>' + b3 + '<br>' + b4 + '<br>' + b5;
    };
    this.newyueLiCalc = function (Ty, Tm, rm, curJD) {
        var w, i, j, k, c, jd, zq, Td0, Tdn, ymd;
        if (rm)rm = yuerun(Ty, Tm);
        Td0 = ymdJd(Ty, Tm, rm, 1);
        ymd = jdYmd(Td0);
        Tdn = ymd.N;
        this.w0 = (Td0 + J2000 + 1 + 7000000) % 7;
        JD.setFromJD(Td0 + J2000);
        this.y = JD.Y;
        this.m = JD.M;
        this.d0 = Td0;
        this.dn = Tdn;
        ...
        for (i = 0, j = 0; i < Tdn; i++) {
            ...
            ob.week = (this.w0 + i) % 7;
            ob.weeki = int2((this.w0 + i) / 7);
            ob.weekN = int2((this.w0 + Tdn - 1) / 7) + 1;
            JD.setFromJD(ob.d0 + J2000);
            ob.y = JD.Y;
            ob.m = JD.M;
            ob.d = JD.D;
            ob.Ldi = i;
            ob.Ldc = obb.rmc[i];
            var wi = XL.S_aLon((Td0 + i) / 36525, 3);
            ob.cur_dz = ob.d0 - int2(obb.qi_accurate((int2(wi / pi2 - 18 / 24) + 18 / 24) * pi2) + 0.5);
            ob.cur_xz = ob.d0 - int2(obb.qi_accurate((int2(wi / pi2 - 6 / 24) + 6 / 24) * pi2) + 0.5);
            ob.cur_lq = ob.d0 - int2(obb.qi_accurate((int2(wi / pi2 - 9 / 24) + 9 / 24) * pi2) + 0.5);
            ob.cur_mz = ob.d0 - int2(obb.qi_accurate((int2(wi / pi2 - 5 / 24) + 5 / 24) * pi2) + 0.5);
            ob.cur_xs = ob.d0 - int2(obb.qi_accurate((int2(wi / pi2 - 7 / 24) + 7 / 24) * pi2) + 0.5);
            ob.Lmc = obb.ymc[(Tm + 1) % 12];
            ob.Ldn = Tdn >= 30 ? '大' : '小';
            ob.Lleap = rm ? '闰' : '';
            ob.Lmc2 = (!rm && yuerun(Ty, Tm)) ? '闰' + obb.ymc[(Tm + 1) % 12] : obb.ymc[(Tm + 2) % 12];
            ob.yxmc = ob.yxjd = ob.yxsj = '';
            ob.jqmc = ob.jqjd = ob.jqsj = '';
            ob.Lyear = Ty - 1984;
            ob.Lyear0 = Ty - 1984;
        ...
        var d, w0, hou, xn, jd2 = Td0 + dt_T(Td0) - 8 / 24;
        w = XL.MS_aLon(jd2 / 36525, 10, 3);
        w = int2((w - 0.78) / Math.PI * 2) * Math.PI / 2;
        do {
            d = obb.so_accurate(w);
    ...
    this.newyueLiHTML = function (Ty, Tm, leap, curJD) {
        var sty_head = ' style="font-family: 宋体; font-size: 14px; text-align: center; background-color: #E0E0FF; color: #000000; font-weight: bold" ';
        var sty_body = ' style="font-family: 宋体; font-size: 12px; text-align: center " ';
        var sty_date = ' style="font-family: 楷体; text-align: center;font-size: 20px" ';
        var sty_date2 = ' style="font-family: 楷体; text-align: center;font-size: 20px; color: #FF0000" ';
        var sty_cur = ' style="background-color:#90D050" ';
        var i, j, c, c2, cr = "", isM;
        var ob;
        this.newyueLiCalc(Ty, Tm, leap, curJD);
        c = ' 农历' + this.Ly + '年【' + this.ShX + '年】';
        if (c.length > 33)c = '<span style="font-size:12px">' + c + '</span>'; else c = '<span style="font-size:16px;font-weight:bold">' + c + '</span>';
        var ta0 = '<tr><td colspan=7 style="background-color:#0000A0" style="color=#FFFF00">' + c + '</td></tr>';
        ta0 += '<tr>' + '<td' + sty_head + 'width="%14">日</td>' + '<td' + sty_head + 'width="%14">一</td>' + '<td' + sty_head + 'width="%14">二</td>' + '<td' + sty_head + 'width="%14">三</td>' + '<td' + sty_head + 'width="%14">四</td>' + '<td' + sty_head + 'width="%14">五</td>' + '<td' + sty_head + 'width="%14">六</td></tr>';
        for (i = 0; i < this.dn; i++) {
...
function jdYmd(jd) {
    ...
    ms = XL.MS_aLon(jd / 36525, 10, 3);
    ms = int2((ms + 2) / pi2) * pi2;
    jd1 = obb.so_accurate(ms);
    if (int2(jd1 + 0.5) > jd) {
        jd2 = jd1;
        jd1 = obb.so_accurate(ms - pi2);
    } else {
        ms += pi2;
        jd2 = obb.so_accurate(ms);
    }
    w1 = XL.S_aLon(jd1 / 36525, 3);
    w1 = int2(w1 / pi2 * 24) * pi2 / 24;
    while (int2(obb.qi_accurate(w1) + 0.5) < int2(jd1 + 0.5))w1 += pi2 / 24;
    w2 = w1;
    while (int2(obb.qi_accurate(w2 + pi2 / 24) + 0.5) < int2(jd2 + 0.5))w2 += pi2 / 24;
    ...
    for (j = 0, ms += pi2, w2 += 1.5 * pi2 / 12; fd && j <= 5; j++) {
        if (int2(obb.qi_accurate(w2 + j * pi2 / 12) + 0.5) < int2(obb.so_accurate(ms + j * pi2) + 0.5)) {
            m++;
            ry = 0;
            if (m > 12) {
                m = 1;
...
function ymdJd(y1, m1, rm, d1) {
    var w, ms, zq, hs, hs1, j;
    w = (y1 - 2000 + (m1 + 10) / 12) * pi2;
    zq = obb.qi_accurate(w);
    ms = XL.MS_aLon(zq / 36525, 10, 3);
    ms = int2((ms + 2) / pi2) * pi2;
    hs = obb.so_accurate(ms);
    if (int2(hs + 0.5) > int2(zq + 0.5)) {
        hs1 = hs;
        hs = obb.so_accurate(ms - pi2);
    } else {
        ms += pi2;
        hs1 = obb.so_accurate(ms);
    }
    if (int2(hs + 0.5) > int2(obb.qi_accurate(w - pi2 / 24) + 0.5) && int2(hs1 + 0.5) > int2(obb.qi_accurate(w + pi2 / 24) + 0.5)) {
        for (j = 0, w += pi2 / 12; j <= 5; j++) {
            if (int2(obb.so_accurate(ms + j * pi2) + 0.5) > int2(obb.qi_accurate(w + j * pi2 / 12) + 0.5)) {
                hs1 = hs;
                hs = obb.so_accurate(ms - 2 * pi2);
                break;
            }
        }
    }
    if (rm)rm = yuerun(y1, m1);
    if (rm == 0)return int2(hs + d1 - 1 + 0.5) + J2000; else return int2(hs1 + d1 - 1 + 0.5) + J2000;
}
function yueJd(y1, m1, rm) {
    return ymdJd(y1, m1, rm, 1);
}
function yuerun(y1, m1) {
    var w, ms, qi, hs, hs1, j;
    w = (y1 - 2000 + (m1 + 10.5) / 12) * pi2;
    qi = obb.qi_accurate(w);
    w += pi2 / 24;
    ms = XL.MS_aLon(qi / 36525, 10, 3);
    ms = int2((ms + 2) / pi2) * pi2;
    hs = obb.so_accurate(ms);
    if (int2(hs + 0.5) > int2(qi + 0.5)) {
        hs1 = hs;
        hs = obb.so_accurate(ms - pi2);
    } else {
        ms += pi2;
    ...
    if (int2(hs + 0.5) > int2(obb.qi_accurate(w - pi2 / 12) + 0.5) && int2(hs1 + 0.5) <= int2(obb.qi_accurate(w) + 0.5)) {
        for (j = 0; j <= 5; j++) {
            w += pi2 / 12;
            ms += pi2;
            if (int2(obb.so_accurate(ms) + 0.5) > int2(obb.qi_accurate(w) + 0.5))return 0;
        }
        return 1;
    } else return 0;
}
...
var ht = {canvas: '', qb: {fillcolor: "#FF0000", filled: "true", stroked: "true", strokecolor: "#00cc00", strokeweight: "1px", strokestyle: "solid"}, line: function (x1, y1, x2, y2) {
    ...
    return this.rect0(x, y, sx, sy, 'image src2="' + src + '"');
...
var tu1 = {isInit: 0, x0: 0, y0: 0, w: 0, h: 0, dx: 0, dy: 0, diming: new Array(116.4, 40, '北京', 119, 25.4, '莆田', 91, 29.7, '拉萨', -73, 41, '纽约', 151, -34, '悉尼', 37, 56, '莫斯科', 30, -20, '非洲南部', -56, -33, '乌拉圭'), init: function (can) {
    ht.canvas = can;
...
var tu2 = {isInit: 0, eR: 150, x0: 240, y0: 280, init: function (can) {
    ht.canvas = can;
    if (this.isInit)return;
    this.isInit = 1;
    this.w = String(can.style.width).replace(/[^0-9]/g, '');
...
var tu3 = {isInit: 0, eR: 250, x0: 350, y0: 300, init: function (can) {
    ht.canvas = can;
    if (this.isInit)return;
    this.isInit = 1;
    this.w = String(can.style.width).replace(/[^0-9]/g, '');
